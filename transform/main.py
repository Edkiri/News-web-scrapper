...
def _extract_newspaper_uid(filename):
	...
	logger.info('Newapaper uid detected: {}'.format(newspaper_uid))

	return newspaper_uid


def _add_newspaper_uid_column(df, newspaper_uid):
	logger.info('Filling newspaper_uid coulumn with {}'.format(newspaper_uid))
...
def _tokenize_column(df, column_name):
	...
	df['_n_tokens_' + column_name] = n_tokens
